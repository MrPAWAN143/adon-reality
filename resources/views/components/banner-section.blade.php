<section class="{{ $class }} bg-cover bg-no-repeat bg-center relative"
    style="background-image: url('{{ $mobileBanner }}');background-position: center; background-size: cover; background-repeat: no-repeat; @media(min-width: 768px) { background-image: url('{{ $image }}'); background-size: cover;background-position: center; background-repeat: no-repeat; }">
