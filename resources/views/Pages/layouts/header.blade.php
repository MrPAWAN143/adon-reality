<header class="w-full bg-white  z-50 sticky top-0 shadow-xl">
  <div class="max-w-7xl mx-auto px-4 sm:px-8 lg:px-8 flex items-center justify-between md:py-4 py-2">
      ...
      <nav class="space-y-2">
        ...
        <div>
          ...
          <div class="l1 hidden mt-2 pl-4 space-y-2">
            ...
            <a href="{{ route('projects', ['category' => 'residential']) }}" class="block text-sm text-txBlack hover:text-black">Residential</a>
            <a href="{{ route('projects', ['category' => 'commercial']) }}" class="block text-sm text-txBlack hover:text-black">Commercial</a>
