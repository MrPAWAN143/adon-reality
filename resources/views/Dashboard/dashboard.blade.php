...
@section('content')
<div
  class="relative flex h-[calc(100vh)] w-full max-w-[20rem] flex-col  bg-blue-200 bg-clip-border p-4 text-gray-700 shadow-xl shadow-blue-gray-900/5">
  <div class="p-4 mb-2">
...
<script type="module">
  $(document).ready(function () {
    $('button').click(function () {
      const $submenu = $(this).closest('.relative').find('.overflow-hidden').first();
