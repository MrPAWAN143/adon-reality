<section class="py-16 bg-white">
    <div class="container mx-auto px-4 text-center">
        <!-- Heading -->
        <h2 class="heading ">Projects on prime location</h2>
        <p class="subheading">
            Discover top-tier properties situated in the most sought-after locations.
        </p>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-full mx-auto ">
            ...
            <a href="" class="relative rounded-3xl overflow-hidden group">
                ...
                <!-- <div class="absolute inset-0 bg-black/30 flex items-center justify-center">
                    <span class="text-white text-3xl font-semibold">Noida</span>
                </div> -->
            </a>
            ...
            <a class="relative rounded-xl overflow-hidden group">
                ...
                <!-- <div class="absolute inset-0 bg-black/30 flex items-center justify-center">
                    <span class="text-white text-3xl font-semibold">Gurugram</span>
                </div> -->
            </a>
            ...
            <a class="relative rounded-xl overflow-hidden group">
                ...
                <!-- <div class="absolute inset-0 bg-black/30 flex items-center justify-center">
                    <span class="text-white text-3xl font-semibold">Delhi</span>
                </div> -->
            </a>
            ...
            <a class="relative rounded-xl overflow-hidden group">
                ...
                <!-- <div class="absolute inset-0 bg-black/30 flex items-center justify-center">
                    <span class="text-white text-3xl font-semibold">Pune</span>
                </div> -->
            </a>
